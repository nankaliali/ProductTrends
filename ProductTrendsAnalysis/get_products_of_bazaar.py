...
with open("bazaar_category.txt", "r") as file:
...
for next_url in product_urls:
    ...
    with open("product_urls_bazaar.txt", "a") as file:
        while True:
            ...
            for item in items:
                url_product = item.find(
                    " div > div.cdz-hover-section > div.cdz-product-top > a"
                )["href"]
